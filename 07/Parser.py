...
class Parser:
    """"A parser object that read a export the vm commands"""

    def __init__(self, filepath):
        """"Constructor of the parser
        :param: filepath - the path of the file
        :param: __commands_queue - queue of commands that need to be translated
        :param: __queue_value - the index of the commands that should be translated in the queue
        :param: the current commands that should be translated
        """
    ...
    def arg2(self):  # API
        ...
        c_call"""
        if self.command_type() != C_ARITHMETIC and self.__cur_command[ARG_1_LOCATION] == TEMP:
